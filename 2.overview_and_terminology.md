...
This specification defines the following application constructed for application developers and application operators to design and operate applications:
