...
| `extension` | unstructured | N | | <kbd>EXPERIMENTAL</kbd> A unstructured field for the implementation to reuse definition object carry extra information for UI or helper purpose. For example, a markdown description of how to use this trait etc. The implementation should NOT abuse this field for functional purpose. |
