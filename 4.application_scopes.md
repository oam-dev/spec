...
| Attribute | Type | Required | Default Value | Description |
|-----------|------|----------|---------------|-------------|
| `type` | `string` | Y | | Determines type of the application scope. For allowed values, see *[Core scope type definitions](#core-scope-type-definitions)* and *[Extended application scope type definitions](#extended-application-scope-type-definitions)*|
...
- **Network scope** - `core.hydra.io/v1.NetworkScope`
- **Health scope** - `core.hydra.io/v1.HealthScope`
...
- **Resource quota scope** - `core.hydra.io/v1.ResourceQuotaScope`
- **Identity scope** - `core.hydra.io/v1.IdentityScope`
