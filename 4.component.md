...
If an extended workload type is declared in a [component schematic](4.component.md), but is not provided by the current platform, the implementation MUST return an error and discontinue the operation.
...
> The available settings are listed on the workload type object. See [section 7](3.workload_types.md) for details.
...
| ------------- |-------------| 
|[2. Overview and Terminology](2.overview_and_terminology.md)    |  [4. Application Scopes](5.application_scopes.md)| 
