...
- **Replicable Task** (`core.hydra.io/v1alpha1.ReplicableTask`): This defines a non-daemonized replicable container instance that will exit when it has completed its workload. Some scaling techniques may be applied to this, but they are likely different scaling techniques than those assigned to ReplicableServices.
