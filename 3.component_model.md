...
An extended resource is a declaration of a resource requirement for an implementation-specific resource. For example, Hydra-compliant platforms may expose special hardware. This field allows components to indicate that such special offerings are required in order for the component to operate.
