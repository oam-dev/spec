...
| Attribute | Type | Required | Default Value | Description |
|-----------|------|----------|---------------|-------------|
| `type` | `string` | Y | | Determines type of the application scope. For allowed values, see *[Core scope type definitions](#core-scope-type-definitions)*|
...
- **Resource quota scope** - `resources.hydra.io/v1.ResourceQuotaScope`
- **Identity scope** - `identity.hydra.io/v1.IdentityScope`
