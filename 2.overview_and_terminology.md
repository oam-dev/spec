...
- Workload: A list of the runnable pieces (OCI images, functions, etc.) used by this component. All built-in component workload types have at least one associated container
