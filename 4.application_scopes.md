...
|Application Metadata|`core.hydra.io/v1alpha1.ApplicationMetadata` | This scope groups components into a logical application, which provides metadata for that application scope. The scope does have any functional impact on components and can therefore be used to describe groupings independent of functionality. |
...
The application metadata scope groups components into a logical application, which provides metadata for that application scope. The scope does have any functional impact on components and can therefore be used to describe groupings independent of functionality.
