...
The following is an example of a complete YAML file that expresses configuration and traits. This example illustrates the four configurational elements of a component: its name, traits, and scopes.
...
The example above illustrates a complete application configuration, including its scopes, component instances and their traits.

<details><summary>(Legacy) Implicit trait name </summary>
