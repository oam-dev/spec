...
If an extended workload type is declared in a [component schematic](3.component_model.md), but is not provided by the current platform, the implementation MUST return an error on discontinue the operation.
