...
| `extension` | unstructured | N | | An unstructured field to carry schematic information for this trait such as **template** and **configurable parameters**. The implementation should NOT abuse this field for functional purpose. |
