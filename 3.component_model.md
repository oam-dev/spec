...
A properties object (for workloadSettings, trait and scope configuration) is an object whose structure is determined by the workload type, trait or scope property schema. It may be a simple value, or it may be a complex object.
